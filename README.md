# Alamo Mobile Brake Repair — Lead-Gen Site

A static, config-driven, SEO-first lead-gen website for **mobile brake repair across San Antonio**.
...
> **Status:** placeholder business identity (company name, phone `(210) 555-0147`, email, domain)
> + free-licensed placeholder brake photos. It builds clean and is ready to launch once you swap in
...
| Setting | Value |
|---|---|
| Company | *Alamo Mobile Brake Repair* (placeholder) |
| Region | San Antonio |
| Cities (11) | San Antonio, Stone Oak, Alamo Heights, Helotes, Leon Valley, Converse, Schertz, Universal City, Live Oak, Cibolo, Boerne |
| Services (7) | `mobile-brake-repair` (hubOnly) + `brake-pad-replacement`, `brake-rotor-replacement`, `brake-caliper-repair`, `brake-fluid-flush`, `brake-inspection`, `emergency-brake-repair` (emergency) |
...
| Phone / email / domain | Placeholders (`(210) 555-0147`, `sanantoniomobilebrakes.com`) — replace before launch |
...
homepage intro/urgency sections, `ServiceAreaMap.astro` `COUNTIES`) — already written for brakes in
San Antonio.
...
2. **Swap the placeholder brake photos** for real local job photos (your work, your truck/van, a tech
   in a San Antonio driveway). The current images are free-licensed Wikimedia Commons stand-ins; real
...
└─ src/
   ...
   └─ assets/               # hero/ services/ (free-licensed brake placeholders)
```
