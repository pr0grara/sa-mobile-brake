...
export const SITE: SiteConfig = {
  company: 'San Antonio Mobile Brakes',
  tagline: 'Mobile Brake Repair & Service',
  trade: 'brake repair',
  phone: '+12105550147', // PLACEHOLDER — replace with real dialable number
  phoneDisplay: '(210) 555-0147', // PLACEHOLDER
  email: 'service@sanantoniomobilebrakes.com', // PLACEHOLDER local-part — confirm the real inbox
  region: 'San Antonio',
  url: 'https://sanantoniomobilebrakes.com', // real domain — keep in sync with astro.config.mjs
